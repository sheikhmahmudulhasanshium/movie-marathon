...
import logo from '../../../../../../public/images/snake-logo.png';
  ...
  return (
    <div className="flex flex-col items-center">
      {gameStarted && !gameOver && (
        <>
          <p className="mb-4 text-lg font-bold text-gray-800 dark:text-white">Score: {score}</p>
          <p className="mb-4 text-lg font-bold text-gray-800 dark:text-white">Level: {level}</p>
