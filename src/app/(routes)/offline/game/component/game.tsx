...
import FoodImage from '../../../../../../public/images/apple.png';
import SnakeHeadImage from '../../../../../../public//images/snake-head.png';
import SnakeBodyImage from '../../../../../../public//images/snake-body.png';
import SnakeTailImage from '../../../../../../public//images/snake-tail.png';
      ...
      <div className="mt-8">
        ...
        {gameStarted && !gameOver && (
          <div className="flex flex-col items-center ">
            <canvas className='dark:bg-white'
              ref={canvasRef}
              width={GRID_SIZE * 20}
              height={GRID_SIZE * 20}
